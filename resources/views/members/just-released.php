...
<div class="container">
    <div class="nav vertnav">
        ...
        <ul>
            <li class="active"><a href="just-released.php">Net uitgebracht</a></li>
            <li><a href="../../../OLDindex.html">Populair</a></li>
            <li><a href="expected.php">Verwacht</a></li>
            <li><a href="favorites.php">Favorieten</a></li>
    ...
    <div class="main margin15">
        ...
        <h1>Net uitgebrachte filmtitels</h1><br>
        <ul class="media">
        ...
        <div class="footer">
            ...
            <div class="footer-service margin15">
                <ul>
                    ...
                    <li><a href="../company/faq.html">Veelgestelde vragen</a></li>
